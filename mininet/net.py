...
class NetworkTopo( Topo ):
    ...
    def build( self, **_opts ):
        ...
        self.addLink( ss, r1, intfName2='eth1', params2={ 'ip' : '10.0.1.1/24' } )
        self.addLink( ss, r2, intfName2='eth1', params2={ 'ip' : '10.0.1.2/24' } )
        ...
        self.addLink( ls, r1, intfName2='eth2', params2={ 'ip' : '10.0.2.1/24' } )
        self.addLink( ls, r2, intfName2='eth2', params2={ 'ip' : '10.0.2.2/24' } )
